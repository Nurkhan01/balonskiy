...
namespace App\Http\Controllers\UniversityMicroservice\SportsFacility;

use App\Http\Controllers\Controller;
use App\Http\Requests\UniversityMicroservice\Accreditation\AccreditationRequest;
use App\Http\Requests\UniversityMicroservice\SportsFacility\SportsFacilityRequest;
use App\Http\Requests\UniversityMicroservice\SportsFacility\UniversitySportsFacilityRequest;
...
{
    private string $action = 'university-sports-facility';
    use HttpRequestTrait;

    /**
     * Возвращает спортивные секции университета отправив запрос на микросервис университетов
    ...
    /**
     * Создает спортивные секции университета отправив запрос на микросервис университетов
    ...
    /**
     * Изменяет спортивные секции университета отправив запрос на микросервис университетов
     * @param Request $request
     * @param HttpRequestService $service
     * @param $id
     * @return mixed|string
    ...
    /**
     * Удаляет спортивные секции университета отправив запрос на микросервис университетов
     * @param HttpRequestService $service
     * @param $id
