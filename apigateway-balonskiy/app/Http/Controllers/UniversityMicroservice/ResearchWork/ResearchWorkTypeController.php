...
use App\Http\Requests\UniversityMicroservice\ResearchWork\ResearchWorkTypeRequest;
...
{
    private string $action = 'research-work/type';
    use HttpRequestTrait;

    /**
     * Получает данные о типах пойсковых работ отправив запрос на микросервис университетов
    ...
    /**
     * Создает данные о типах пойсковых работ отправив запрос на микросервис университетов
    ...
    /**
     * Изменяет данные о типах пойсковых работ отправив запрос на микросервис университетов
     * @param Request $request
     * @param HttpRequestService $service
     * @param $id
     * @return mixed|string
    ...
    /**
     * Удаляет данные о типах пойсковых работ отправив запрос на микросервис университетов
     * @param HttpRequestService $service
     * @param $id
