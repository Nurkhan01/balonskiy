...
use App\Http\Requests\UniversityMicroservice\Laboratory\UniversityLaboratoryRequest;
...
{
    private string $action = 'university-laboratory';
    use HttpRequestTrait;

    /**
     * Получает данные о лабораториях университетов отправив запрос на микросервис университетов
    ...
    /**
     * Создает данные о лабораториях университетов отправив запрос на микросервис университетов
    ...
    /**
     * Изменяет данные о лабораториях университетов отправив запрос на микросервис университетов
     * @param Request $request
     * @param HttpRequestService $service
     * @param $id
     * @return mixed|string
    ...
    /**
     * Удаляет данные о лабораториях университетов отправив запрос на микросервис университетов
     * @param HttpRequestService $service
     * @param $id
