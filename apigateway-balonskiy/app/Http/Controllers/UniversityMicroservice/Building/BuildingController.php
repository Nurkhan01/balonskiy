...
use App\Http\Requests\UniversityMicroservice\Building\BuildingRequest;
...
{
    private string $action = 'building';
    use HttpRequestTrait;

    /**
     * Получает данные о здании отправив запрос на микросервис университетов
    ...
    /**
     * Создает данные о здании отправив запрос на микросервис университетов
    ...
    /**
     * Изменяет данные о здании отправив запрос на микросервис университетов
     * @param Request $request
     * @param HttpRequestService $service
     * @param $id
     * @return mixed|string
    ...
    /**
     * Удаляет данные о здании отправив запрос на микросервис университетов
     * @param HttpRequestService $service
     * @param $id
