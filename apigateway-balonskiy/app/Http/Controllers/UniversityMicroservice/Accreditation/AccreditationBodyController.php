...
use App\Http\Requests\UniversityMicroservice\Accreditation\AccreditationBodyRequest;
...
{
    private string $action = 'accreditation/body';
    use HttpRequestTrait;

    /**
     * Получает данные о теле(содержании) аккредитации отправив запрос на микросервис университетов
    ...
    /**
     * Создает данные о теле(содержании) аккредитации отправив запрос на микросервис университетов
    ...
    /**
     * Изменяет данные о теле(содержании) аккредитации отправив запрос на микросервис университетов
     * @param Request $request
     * @param HttpRequestService $service
     * @param $id
     * @return mixed|string
    ...
    /**
     * Удаляет данные о теле(содержании) аккредитации отправив запрос на микросервис университетов
     * @param HttpRequestService $service
     * @param $id
