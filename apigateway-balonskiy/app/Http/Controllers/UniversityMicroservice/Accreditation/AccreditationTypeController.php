...
class AccreditationTypeController extends Controller
{
    ...
    /**
     * Получает данные о типах аккредитации отправив запрос на микросервис университетов
    ...
    /**
     * Создает данные о типах аккредитации отправив запрос на микросервис университетов
    ...
    /**
     * Изменяет данные о типах аккредитации отправив запрос на микросервис университетов
     * @param Request $request
     * @param HttpRequestService $service
     * @param $id
     * @return mixed|string
    ...
    /**
     * Удаляет данные о типах аккредитации отправив запрос на микросервис университетов
     * @param HttpRequestService $service
     * @param $id
