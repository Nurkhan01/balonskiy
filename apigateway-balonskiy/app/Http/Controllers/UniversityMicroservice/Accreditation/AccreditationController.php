...
{
    private string $action = 'accreditation';
    use HttpRequestTrait;

    /**
     * Получает данные об аккредитации отправив запрос на микросервис университетов
    ...
    /**
     * Создает данные об аккредитации отправив запрос на микросервис университетов
    ...
    /**
     * Изменяет данные об аккредитации отправив запрос на микросервис университетов
     * @param Request $request
     * @param HttpRequestService $service
     * @param $id
     * @return mixed|string
    ...
    /**
     * Удаляет данные об аккредитации отправив запрос на микросервис университетов
     * @param HttpRequestService $service
     * @param $id
