...
namespace App\Http\Controllers\UniversityMicroservice\SpecialNeedsCondition;

use App\Http\Controllers\Controller;
use App\Http\Requests\UniversityMicroservice\Accreditation\AccreditationRequest;
use App\Http\Requests\UniversityMicroservice\SpecialNeedsCondition\SpecialNeedsConditionRequest;
...
{
    private string $action = 'special-needs-condition';
    use HttpRequestTrait;

    /**
     * Получает данные о состоянии особых потребностей отправив запрос на микросервис университетов
    ...
    /**
     * Создает данные о состоянии особых потребностей отправив запрос на микросервис университетов
    ...
    /**
     * Изменяет данные о состоянии особых потребностей отправив запрос на микросервис университетов
     * @param Request $request
     * @param HttpRequestService $service
     * @param $id
     * @return mixed|string
    ...
    /**
     * Удаляет данные о состоянии особых потребностей отправив запрос на микросервис университетов
     * @param HttpRequestService $service
     * @param $id
