...
{
    private string $action = 'university/science-funding-type';
    use HttpRequestTrait;

    /**
     * Возвращает тип научного финансирования отправив запрос на микросервис университетов
    ...
    /**
     * Создает тип научного финансирования отправив запрос на микросервис университетов
    ...
    /**
     * Изменяет тип научного финансирования отправив запрос на микросервис университетов
     * @param Request $request
     * @param HttpRequestService $service
     * @param $id
     * @return mixed|string
    ...
    /**
     * Удаляет тип научного финансирования отправив запрос на микросервис университетов
     * @param HttpRequestService $service
     * @param $id
