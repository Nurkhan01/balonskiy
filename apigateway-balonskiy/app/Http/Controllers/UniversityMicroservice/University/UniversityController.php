...
use App\Http\Requests\UniversityMicroservice\University\UniversityRequest;
...
{
    private string $action = 'university';

    use HttpRequestTrait;

    /**
     * Возвращает данные университетов отправив запрос на микросервис университетов
    ...
    /**
     * Создает данные университетов отправив запрос на микросервис университетов
    ...
    /**
     * Изменяет данные университетов отправив запрос на микросервис университетов
     * @param Request $request
     * @param HttpRequestService $service
     * @param $id
     * @return mixed|string
    ...
    /**
     * Удаляет данные университетов отправив запрос на микросервис университетов
     * @param HttpRequestService $service
     * @param $id
