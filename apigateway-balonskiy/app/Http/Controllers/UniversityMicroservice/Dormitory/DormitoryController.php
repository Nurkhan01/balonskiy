...
use App\Http\Requests\UniversityMicroservice\Dormitory\DormitoryRequest;
...
{
    private string $action = 'dormitory';
    use HttpRequestTrait;

    /**
     * Получает данные о общежитиях отправив запрос на микросервис университетов
    ...
    /**
     * Создает данные о общежитиях отправив запрос на микросервис университетов
    ...
    /**
     * Изменяет данные о общежитиях отправив запрос на микросервис университетов
     * @param Request $request
     * @param HttpRequestService $service
     * @param $id
     * @return mixed|string
    ...
    /**
     * Удаляет данные о общежитиях отправив запрос на микросервис университетов
     * @param HttpRequestService $service
     * @param $id
