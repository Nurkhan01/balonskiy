...
/**
 * @OA\Post(
 *     path="/api/research-work/type/create",
 *     summary="Добавляет данные о типах пойсковых работ",
 *     tags={"ResearchWorkType"},
 *     security={{ "bearerAuth": {} }},
 *     @OA\RequestBody(
 *         @OA\MediaType(
 ...
 * ),
 * @OA\Get(
 *     path="/api/research-work/type",
 *     summary="Получает данные о типах пойсковых работ",
 *     tags={"ResearchWorkType"},
 *     security={{ "bearerAuth": {} }},
 *     @OA\Response(
 *         response=200,
 ...
 * ),
 * @OA\Put(
 *     path="/api/research-work/type/update/{id}",
 *     summary="Обновляет данные о типах пойсковых работ",
 *     tags={"ResearchWorkType"},
 *     security={{ "bearerAuth": {} }},
 *     @OA\Parameter(
 *         description="ID",
 ...
 * ),
 * @OA\Delete(
 *     path="/api/research-work/type/delete/{id}",
 *     summary="Удаляет данные о типах пойсковых работ",
 *     tags={"ResearchWorkType"},
 *     security={{ "bearerAuth": {} }},
 *     @OA\Parameter(
 *         description="ID",
