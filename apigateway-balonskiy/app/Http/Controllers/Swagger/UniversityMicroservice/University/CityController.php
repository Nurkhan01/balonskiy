...
/**
 * @OA\Post(
 *     path="/api/university/city/create",
 *     summary="Добавляет города",
 *     tags={"City"},
 *     security={{ "bearerAuth": {} }},
 *     @OA\RequestBody(
 *         @OA\MediaType(
 ...
 * ),
 * @OA\Get(
 *     path="/api/university/city",
 *     summary="Получает города",
 *     tags={"City"},
 *     security={{ "bearerAuth": {} }},
 *     @OA\Response(
 *         response=200,
 ...
 * ),
 * @OA\Put(
 *     path="/api/university/city/update/{id}",
 *     summary="Обновляет города",
 *     tags={"City"},
 *     security={{ "bearerAuth": {} }},
 *     @OA\Parameter(
 *         description="ID",
 ...
 * ),
 * @OA\Delete(
 *     path="/api/university/city/delete/{id}",
 *     summary="Удаляет города",
 *     tags={"City"},
 *     security={{ "bearerAuth": {} }},
 *     @OA\Parameter(
 *         description="ID",
