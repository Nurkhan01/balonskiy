...
/**
 * @OA\Post(
 *     path="/api/study-level/create",
 *     summary="Добавляет данные об уровнях образования",
 *     tags={"StudyLevel"},
 *     security={{ "bearerAuth": {} }},
 *     @OA\RequestBody(
 *         @OA\MediaType(
 ...
 * ),
 * @OA\Get(
 *     path="/api/study-level",
 *     summary="Получает данные об уровнях образования ",
 *     tags={"StudyLevel"},
 *     security={{ "bearerAuth": {} }},
 *     @OA\Response(
 *         response=200,
 ...
 * ),
 * @OA\Put(
 *     path="/api/study-level/update/{id}",
 *     summary="Обновляет уровень образования",
 *     tags={"StudyLevel"},
 *     security={{ "bearerAuth": {} }},
 *     @OA\Parameter(
 *         description="ID",
 ...
 * ),
 * @OA\Delete(
 *     path="/api/study-level/delete/{id}",
 *     summary="Удаляет уровень образования",
 *     tags={"StudyLevel"},
 *     security={{ "bearerAuth": {} }},
 *     @OA\Parameter(
 *         description="ID",
