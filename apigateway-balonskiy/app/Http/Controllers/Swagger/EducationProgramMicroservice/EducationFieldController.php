...
/**
 * @OA\Post(
 *     path="/api/education-field/create",
 *     summary="Добавляет данные о полях образования",
 *     tags={"EducationField"},
 *     security={{ "bearerAuth": {} }},
 *     @OA\RequestBody(
 *         @OA\MediaType(
 ...
 * ),
 * @OA\Get(
 *     path="/api/education-field",
 *     summary="Получает данные о полях образования",
 *     tags={"EducationField"},
 *     security={{ "bearerAuth": {} }},
 *     @OA\Response(
 *         response=200,
 ...
 * ),
 * @OA\Put(
 *     path="/api/education-field/update/{id}",
 *     summary="Обновляет поля образования",
 *     tags={"EducationField"},
 *     security={{ "bearerAuth": {} }},
 *     @OA\Parameter(
 *         description="ID",
 ...
 * ),
 * @OA\Delete(
 *     path="/api/education-field/delete/{id}",
 *     summary="Удаляет поля образования",
 *     tags={"EducationField"},
 *     security={{ "bearerAuth": {} }},
 *     @OA\Parameter(
 *         description="ID",
