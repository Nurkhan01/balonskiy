...
{
    private string $action = 'study-level';
    use HttpRequestTrait;

    /**
     * Получает данные об уровнях образования отправив запрос на микросервис образовательных программ
    ...
    /**
     * Создает данные об уровнях образования отправив запрос на микросервис  образовательных программ
    ...
    /**
     * Изменяет данные об уровнях образования отправив запрос на микросервис  образовательных программ
     * @param Request $request
     * @param HttpRequestService $service
     * @param $id
     * @return mixed|string
