...
use App\Http\Requests\EducationProgramMicroservice\EducationProgramRequest;
...
{
    private string $action = 'education-program';
    use HttpRequestTrait;

    /**
     * Получает данные об образовательных программах отправив запрос на микросервис образовательных программ
    ...
    /**
     * Изменяет данные об образовательных программах отправив запрос на микросервис  образовательных программ
     * @param Request $request
     * @param HttpRequestService $service
     * @param $id
     * @return mixed|string
    ...
    /**
     * Удаляет данные об образовательных программах отправив запрос на микросервис  образовательных программ
     * @param HttpRequestService $service
     * @param $id
