...
class JointEducationProgramController extends Controller
{
    ...
    /**
     * Получает данные об объединенных образовательных программах отправив запрос на микросервис образовательных программ
    ...
    /**
     * Создает данные об объединенных образовательных программах отправив запрос на микросервис  образовательных программ
    ...
    /**
     * Изменяет данные об объединенных образовательных программах отправив запрос на микросервис  образовательных программ
     * @param Request $request
     * @param HttpRequestService $service
     * @param $id
     * @return mixed|string
    ...
    /**
     * Удаляет данные об объединенных образовательных программах отправив запрос на микросервис  образовательных программ
     * @param HttpRequestService $service
     * @param $id
