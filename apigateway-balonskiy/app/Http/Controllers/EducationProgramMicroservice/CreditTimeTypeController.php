...
{
    private string $action = 'credit-time-type';
    use HttpRequestTrait;

    /**
     * Получает данные о типах кредитов отправив запрос на микросервис образовательных программ
    ...
    /**
     * Создает данные о типах кредитов отправив запрос на микросервис  образовательных программ
    ...
    /**
     * Изменяет данные о типах кредитов отправив запрос на микросервис  образовательных программ
     * @param Request $request
     * @param HttpRequestService $service
     * @param $id
     * @return mixed|string
    ...
    /**
     * Удаляет данные о типах кредитов отправив запрос на микросервис  образовательных программ
     * @param HttpRequestService $service
     * @param $id
