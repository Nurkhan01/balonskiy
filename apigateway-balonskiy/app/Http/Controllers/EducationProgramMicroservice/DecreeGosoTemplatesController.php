...
use App\Http\Requests\EducationProgramMicroservice\DecreeGosoTemplatesRequest;
...
{
    private string $action = 'decree-goso-templates';
    use HttpRequestTrait;

    /**
     * Получает данные об образцах указов ГОСО отправив запрос на микросервис образовательных программ
    ...
    /**
     * Создает данные об образцах указов ГОСО отправив запрос на микросервис  образовательных программ
    ...
    /**
     * Изменяет данные об образцах указов ГОСО отправив запрос на микросервис  образовательных программ
     * @param Request $request
     * @param HttpRequestService $service
     * @param $id
     * @return mixed|string
    ...
    /**
     * Удаляет данные об образцах указов ГОСО отправив запрос на микросервис  образовательных программ
     * @param HttpRequestService $service
     * @param $id
