...
{
    private string $action = 'education-field';
    use HttpRequestTrait;

    /**
     * Получает данные о полях образования отправив запрос на микросервис образовательных программ
    ...
    /**
     * Создает данные о полях образования отправив запрос на микросервис  образовательных программ
    ...
    /**
     * Изменяет данные о полях образования отправив запрос на микросервис  образовательных программ
     * @param Request $request
     * @param HttpRequestService $service
     * @param $id
     * @return mixed|string
    ...
    /**
     * Удаляет данные о полях образования отправив запрос на микросервис  образовательных программ
     * @param HttpRequestService $service
     * @param $id
