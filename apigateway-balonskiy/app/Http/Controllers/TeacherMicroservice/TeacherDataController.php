...
namespace App\Http\Controllers\TeacherMicroservice;
...
{
    private string $action = 'teacher';

    use HttpRequestTrait;

    /**
     * Получает данные о ППС отправив запрос на микросервис преподователей
    ...
    /**
     * Создает данные о ППС отправив запрос на микросервис преподователей
    ...
    /**
     * Изменяет данные о ППС отправив запрос на микросервис преподователей
     * @param Request $request
     * @param HttpRequestService $service
     * @param $id
     * @return mixed|string
    ...
    /**
     * Удаляет данные о ППС отправив запрос на микросервис преподователей
     * @param HttpRequestService $service
     * @param $id
