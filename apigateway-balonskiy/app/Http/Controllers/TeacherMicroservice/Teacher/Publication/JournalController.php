...
use App\Http\Requests\TeacherMicroservice\Teacher\Publication\JournalRequest;
...
{
    private string $action = 'publication/journal';
    use HttpRequestTrait;

    /**
     * Получает данные о журналах в которых опубликованы публикации ППС отправив запрос на микросервис преподователей
    ...
    /**
     * Создает данные о журналах в которых опубликованы публикации ППС отправив запрос на микросервис преподователей
    ...
    /**
     * Изменяет данные о журналах в которых опубликованы публикации ППС отправив запрос на микросервис преподователей
     * @param Request $request
     * @param HttpRequestService $service
     * @param $id
     * @return mixed|string
    ...
    /**
     * Удаляет данные о журналах в которых опубликованы публикации ППС отправив запрос на микросервис преподователей
     * @param HttpRequestService $service
     * @param $id
