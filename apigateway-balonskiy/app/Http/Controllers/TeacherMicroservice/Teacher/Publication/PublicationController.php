...
use App\Http\Requests\TeacherMicroservice\Teacher\Publication\PublicationRequest;
...
{
    private string $action = 'publication';
    use HttpRequestTrait;

    /**
     * Получает данные о публикациях отправив запрос на микросервис преподователей
    ...
    /**
     * Создает данные о публикациях отправив запрос на микросервис преподователей
    ...
    /**
     * Изменяет данные о публикациях отправив запрос на микросервис преподователей
     * @param Request $request
     * @param HttpRequestService $service
     * @param $id
     * @return mixed|string
    ...
    /**
     * Удаляет данные о публикациях отправив запрос на микросервис преподователей
     * @param HttpRequestService $service
     * @param $id
