...
use App\Http\Requests\TeacherMicroservice\Teacher\Training\TrainingRequest;
...
{
    private string $action = 'training';
    use HttpRequestTrait;

    /**
     * Получает данные о тренингах отправив запрос на микросервис преподователей
    ...
    /**
     * Создает данные о тренингах отправив запрос на микросервис преподователей
    ...
    /**
     * Изменяет данные о тренингах отправив запрос на микросервис преподователей
     * @param Request $request
     * @param HttpRequestService $service
     * @param $id
     * @return mixed|string
    ...
    /**
     * Удаляет данные о тренингах отправив запрос на микросервис преподователей
     * @param HttpRequestService $service
     * @param $id
