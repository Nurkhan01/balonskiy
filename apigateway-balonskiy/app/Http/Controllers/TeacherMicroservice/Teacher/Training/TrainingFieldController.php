...
use App\Http\Requests\TeacherMicroservice\Teacher\Training\TrainingFieldRequest;
...
{
    private string $action = 'training/field';
    use HttpRequestTrait;

    /**
     * Получает данные о полях тренинга отправив запрос на микросервис преподователей
    ...
    /**
     * Создает данные о полях тренинга отправив запрос на микросервис преподователей
    ...
    /**
     * Изменяет данные о полях тренинга отправив запрос на микросервис преподователей
     * @param Request $request
     * @param HttpRequestService $service
     * @param $id
     * @return mixed|string
    ...
    /**
     * Удаляет данные о полях тренинга отправив запрос на микросервис преподователей
     * @param HttpRequestService $service
     * @param $id
