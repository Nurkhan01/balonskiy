...
class MobilityPaymentTypeController extends Controller
{
    ...
    /**
     * Получает данные о типах оплат мобильности отправив запрос на микросервис студентов
    ...
    /**
     * Создает данные о типах оплат мобильности отправив запрос на микросервис студентов
    ...
    /**
     * Изменяет данные о типах оплат мобильности отправив запрос на микросервис студентов
     * @param Request $request
     * @param HttpRequestService $service
     * @param $id
     * @return mixed|string
    ...
    /**
     * Удаляет данные о типах оплат мобильности отправив запрос на микросервис студентов
     * @param HttpRequestService $service
     * @param $id
