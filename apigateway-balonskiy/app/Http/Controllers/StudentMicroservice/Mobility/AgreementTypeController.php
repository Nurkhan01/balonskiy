...
use App\Http\Requests\StudentMicroservice\Mobility\AgreementTypeRequest;
...
{
    private string $action = 'mobility/agreement-type';
    use HttpRequestTrait;

    /**
     * Получает данные о типах соглашения отправив запрос на микросервис студентов
    ...
    /**
     * Создает данные о типах соглашения отправив запрос на микросервис студентов
    ...
    /**
     * Изменяет данные о типах соглашения отправив запрос на микросервис студентов
     * @param Request $request
     * @param HttpRequestService $service
     * @param $id
     * @return mixed|string
    ...
    /**
     * Удаляет данные о типах соглашения отправив запрос на микросервис студентов
     * @param HttpRequestService $service
     * @param $id
