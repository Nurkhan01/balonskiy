...
use App\Http\Requests\StudentMicroservice\Mobility\MobilityTypeRequest;
...
{
    private string $action = 'mobility/type';
    use HttpRequestTrait;

    /**
     * Получает данные о типах академической мобильности отправив запрос на микросервис студентов
    ...
    /**
     * Создает данные о типах академической мобильности отправив запрос на микросервис студентов
    ...
    /**
     * Изменяет данные о типах академической мобильности отправив запрос на микросервис студентов
     * @param Request $request
     * @param HttpRequestService $service
     * @param $id
     * @return mixed|string
    ...
    /**
     * Удаляет данные о типах академической мобильности отправив запрос на микросервис студентов
     * @param HttpRequestService $service
     * @param $id
