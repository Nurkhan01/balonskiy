...
use App\Http\Requests\StudentMicroservice\Student\StudyFormRequest;
...
{
    private string $action = 'student/study-form';
    use HttpRequestTrait;

    /**
     * Получает данные о формах обучения отправив запрос на микросервис студентов
    ...
    /**
     * Создает данные о формах обучения отправив запрос на микросервис студентов
    ...
    /**
     * Изменяет данные о формах обучения отправив запрос на микросервис студентов
     * @param Request $request
     * @param HttpRequestService $service
     * @param $id
     * @return mixed|string
    ...
    /**
     * Удаляет данные о формах обучения отправив запрос на микросервис студентов
     * @param HttpRequestService $service
     * @param $id
