...
class StudentSportsCategoryController extends Controller
{
    ...
    /**
     * Получает данные о категориях спорта студентов отправив запрос на микросервис студентов
    ...
    /**
     * Создает данные о категориях спорта студентов отправив запрос на микросервис студентов
    ...
    /**
     * Изменяет данные о категориях спорта студентов отправив запрос на микросервис студентов
     * @param Request $request
     * @param HttpRequestService $service
     * @param $id
     * @return mixed|string
    ...
    /**
     * Удаляет данные о категориях спорта студентов отправив запрос на микросервис студентов
     * @param HttpRequestService $service
     * @param $id
