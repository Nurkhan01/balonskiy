...
use App\Http\Requests\StudentMicroservice\Student\EnrollStatusRequest;
...
{
    private string $action = 'student/enroll-status';
    use HttpRequestTrait;

    /**
     * Получает данные о статусах регистрации отправив запрос на микросервис студентов
    ...
    /**
     * Создает данные о статусах регистрации отправив запрос на микросервис студентов
    ...
    /**
     * Изменяет данные о статусах регистрации отправив запрос на микросервис студентов
     * @param Request $request
     * @param HttpRequestService $service
     * @param $id
     * @return mixed|string
    ...
    /**
     * Удаляет данные о статусах регистрации отправив запрос на микросервис студентов
     * @param HttpRequestService $service
     * @param $id
