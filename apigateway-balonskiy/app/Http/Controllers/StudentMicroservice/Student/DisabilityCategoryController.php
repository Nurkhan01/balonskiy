...
use App\Http\Requests\StudentMicroservice\Student\DisabilityCategoryRequest;
...
{
    private string $action = 'student/disability-category';
    use HttpRequestTrait;

    /**
     * Получает данные о категориях инвалидности отправив запрос на микросервис студентов
    ...
    /**
     * Создает данные о категориях инвалидности отправив запрос на микросервис студентов
    ...
    /**
     * Изменяет данные о категориях инвалидности отправив запрос на микросервис студентов
     * @param Request $request
     * @param HttpRequestService $service
     * @param $id
     * @return mixed|string
    ...
    /**
     * Удаляет данные о категориях инвалидности отправив запрос на микросервис студентов
     * @param HttpRequestService $service
     * @param $id
