...
use App\Http\Requests\StudentMicroservice\Student\NationalityRequest;
...
{
    private string $action = 'student/nationality';
    use HttpRequestTrait;

    /**
     * Получает данные о национальностях отправив запрос на микросервис студентов
    ...
    /**
     * Создает данные о национальностях отправив запрос на микросервис студентов
    ...
    /**
     * Изменяет данные о национальностях отправив запрос на микросервис студентов
     * @param Request $request
     * @param HttpRequestService $service
     * @param $id
     * @return mixed|string
    ...
    /**
     * Удаляет данные о национальностях отправив запрос на микросервис студентов
     * @param HttpRequestService $service
     * @param $id
