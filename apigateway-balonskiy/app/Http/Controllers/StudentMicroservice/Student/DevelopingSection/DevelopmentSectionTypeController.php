...
use App\Http\Requests\StudentMicroservice\Student\DevelopingSection\DevelopmentSectionTypeRequest;
...
{
    private string $action = 'developing-section/type';
    use HttpRequestTrait;

    /**
     * Получает данные о типах секции развития отправив запрос на микросервис студентов
    ...
    /**
     * Создает данные о типах секции развития отправив запрос на микросервис студентов
    ...
    /**
     * Изменяет данные о типах секции развития отправив запрос на микросервис студентов
     * @param Request $request
     * @param HttpRequestService $service
     * @param $id
     * @return mixed|string
    ...
    /**
     * Удаляет данные о типах секции развития отправив запрос на микросервис студентов
     * @param HttpRequestService $service
     * @param $id
