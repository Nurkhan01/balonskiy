...
use App\Http\Requests\StudentMicroservice\Student\DevelopingSection\CompetitionWinnerRequest;
...
{
    private string $action = 'competition-winner';
    use HttpRequestTrait;

    /**
     * Получает данные о победителях конкурса отправив запрос на микросервис студентов
    ...
    /**
     * Создает данные о победителях конкурса отправив запрос на микросервис студентов
    ...
    /**
     * Изменяет данные о победителях конкурса отправив запрос на микросервис студентов
     * @param Request $request
     * @param HttpRequestService $service
     * @param $id
     * @return mixed|string
    ...
    /**
     * Удаляет данные о победителях конкурса отправив запрос на микросервис студентов
     * @param HttpRequestService $service
     * @param $id
