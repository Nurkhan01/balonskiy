...
class DevelopingSectionController extends Controller
{
    ...
    /**
     * Получает данные о секциях развития отправив запрос на микросервис студентов
    ...
    /**
     * Создает данные о секциях развития отправив запрос на микросервис студентов
    ...
    /**
     * Изменяет данные о секциях развития отправив запрос на микросервис студентов
     * @param Request $request
     * @param HttpRequestService $service
     * @param $id
     * @return mixed|string
    ...
    /**
     * Удаляет данные о секциях развития отправив запрос на микросервис студентов
     * @param HttpRequestService $service
     * @param $id
