...
class EmploymentController extends Controller
{
    ...
    /**
     * Получает данные о трудоустройстве отправив запрос на микросервис студентов
    ...
    /**
     * Создает данные о трудоустройстве отправив запрос на микросервис студентов
    ...
    /**
     * Изменяет данные о трудоустройстве отправив запрос на микросервис студентов
     * @param Request $request
     * @param HttpRequestService $service
     * @param $id
     * @return mixed|string
    ...
    /**
     * Удаляет данные о трудоустройстве отправив запрос на микросервис студентов
     * @param HttpRequestService $service
     * @param $id
